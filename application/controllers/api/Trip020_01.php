 ...
 */
class Trip020_01 extends REST_Controller {
            ...
            if($det["tgl_restan"] != "") {
                $sql = "
                    INSERT INTO tbl_trip_020_detail(
                        id_trip, id_blok, jumlah_janjang, jumlah_restan, tgl_restan
                    ) VALUES(
                        '" . $id_nya . "', '" . $det["id_blok"] . "', '" . $det["jumlah_janjang"] . "', '" . $det["jumlah_restan"] . "', '" . $det["tgl_restan"] . "'
                    )
                ";
                $this->db->query($sql);
            } else {
