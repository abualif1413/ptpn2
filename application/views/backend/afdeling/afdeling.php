        ...
        <div class="card">
          <div class="card-header">
            <h6 class="text-uppercase mb-0">
                ...
                <label class="pull-right">Data Afdeling</label>
            </h6>
          </div>
          <div class="card-body">
      ...
      <div class="modal-body">
        <?php echo form_open('', array('id' => 'myForm')); ?>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="id_kebun">
...
<script type="text/javascript">
    ...
    $('#btnAdd').click(function () {
        $('#myModal').modal('show');
        $('#myForm').attr('action','<?php echo site_url('Afdeling/Add_Afdeling')?>');
    ...
    $(document).ready(function() {
        $("#DataTable_Afdeling").DataTable({
            ...
            ajax: {
                url: '<?php echo base_url('Afdeling/Data_Afdeling');?>',
                type: 'POST',
  ...
  function Update(id){
      ...
      $('#btnSave').html('Update');
      $('#myModal').modal('show');
      $('#myForm').attr('action','<?php echo site_url('Afdeling/Update_Afdeling')?>');
      $('#myModal').find('.modal-title').text('Ubah Data');
      $.ajax({
          type : 'GET',
          async: false,
          url  : '<?php echo site_url('Afdeling/Edit_Afdeling')?>',
          data:{
              id:id,
          ...
          success:function(data){
            console.log(data);
              ...
              $('input[name=nama_afdeling]').val(data.nama_afdeling);
  ...
  function Delete(id) {
    ...
    $.ajax({
        type : 'ajax',
        method :'get',
        url  :'<?php echo site_url('Afdeling/Delete_Afdeling')?>',
        data:{
          id:id,
          '<?php echo $this->security->get_csrf_token_name();?>':'<?php echo $this->security->get_csrf_hash();?>'
        },
