...
<script type="text/javascript">
    ...
    $('#btnAdd').click(function () {
        kode_barcode();
        $('#myModal').modal('show');
        $('#myForm').attr('action','<?php echo site_url('DataPemanenadmin/add_data_pemanen')?>');
    ...
    $(document).ready(function() {
        $("#DataTable_users").DataTable({
            ...
            ajax: {
                url: '<?php echo base_url('DataPemanenadmin/data_pemanen');?>',
                type: 'POST',
  ...
  function Update(id){
      ...
      $('#btnSave').html('Update');
      $('#myModal').modal('show');
      $('#myForm').attr('action','<?php echo site_url('DataPemanenadmin/update_Pemanen')?>');
      $('#myModal').find('.modal-title').text('Ubah Data');
      $.ajax({
          type : 'GET',
          async: false,
          url  : '<?php echo site_url('DataPemanenadmin/Edit_Pemanen')?>',
          data:{
              id:id,
  ...
  function Delete(id) {
    ...
    $.ajax({
        type : 'ajax',
        method :'get',
        url  :'<?php echo site_url('DataPemanenadmin/Delete_Pemanen')?>',
        data:{
          id:id,
          '<?php echo $this->security->get_csrf_token_name();?>':'<?php echo $this->security->get_csrf_hash();?>'
        },
    ...
    //     $.ajax({
    //         type : 'ajax',
    //         url  : '<?php echo site_url('DataPemanenadminadmin/barcode')?>',
    //         async: false,
    //         dataType :'json',
    //         success:function(response){
